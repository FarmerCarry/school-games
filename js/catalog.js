...
window.GAMES = [
  { slug: 'rail-rush', title: 'عدّاء السكة', cats: ['running'], players: '1', color: '#ff7a1a', hot: true,
  ...
  { slug: 'neon-slope', title: 'منحدر النيون', cats: ['running', 'arcade'], players: '1', color: '#22e3a1', hot: true,
    blurb: 'تدحرج على منحدر نيون لا ينتهي. إلى أي مدى ستصل؟',
    controls: [{ keys: ['←', '→'], action: 'توجيه' }] },
  { slug: 'tunnel-blitz', title: 'نفق السرعة', cats: ['running', 'arcade'], players: '1', color: '#b44dff',
    blurb: 'انطلق بسرعة جنونية داخل نفق يدور!',
    controls: [{ keys: ['←', '→'], action: 'تدوير النفق' }] },
  { slug: 'beat-dash', title: 'قفزة الإيقاع', cats: ['running', 'arcade'], players: '1', color: '#00c2ff', hot: true,
    blurb: 'اقفز مع الإيقاع فوق الأشواك. هل تنهي كل المراحل؟',
    controls: [{ keys: ['مسافة', 'انقر'], action: 'قفز' }] },
  { slug: 'swing-hook', title: 'الخطّاف الطائر', cats: ['arcade'], players: '1', color: '#ff4fa3',
    blurb: 'تشبّث وتأرجح وانطلق نحو خط النهاية!',
    controls: [{ keys: ['انقر', 'مسافة'], action: 'اضغط مطولًا للتشبث' }] },
  { slug: 'moto-madness', title: 'جنون الدراجات', cats: ['racing'], players: '1', color: '#ff3b3b', hot: true,
    blurb: 'قُد دراجتك فوق منحدرات مجنونة ونفّذ الشقلبات.',
    controls: [{ keys: ['↑'], action: 'تسارع' }, { keys: ['↓'], action: 'فرامل' }, { keys: ['←', '→'], action: 'ميلان وشقلبة' }] },
  { slug: 'drift-king', title: 'ملك الانزلاق', cats: ['racing'], players: '1', color: '#ffc21a',
    blurb: 'زر واحد وانزلاق بلا نهاية. لا تسقط عن الطريق!',
    controls: [{ keys: ['مسافة', 'انقر'], action: 'اضغط مطولًا للالتفاف' }] },
  { slug: 'fire-and-ice', title: 'النار والجليد', cats: ['two-player', 'puzzle'], players: '1-2', color: '#ff5a1f', hot: true,
  ...
  { slug: 'tank-splat', title: 'دبابات الألوان', cats: ['two-player', 'battle'], players: '1-3', color: '#4caf50',
  ...
  { slug: 'sumo-bonk', title: 'مصارعة السومو', cats: ['two-player', 'sports'], players: '1-2', color: '#ff8fb1',
    blurb: 'مصارعة سومو متمايلة. ادفع خصمك خارج الحلبة!',
    controls: [{ keys: ['W', 'S'], action: 'اللاعب 1: قفز / دفعة' }, { keys: ['↑', '↓'], action: 'اللاعب 2: قفز / دفعة' }] },
  { slug: 'air-hockey', title: 'هوكي الهواء', cats: ['two-player', 'sports'], players: '1-2', color: '#00d1ff',
  ...
  { slug: 'hoop-heads', title: 'سلة الرؤوس الكبيرة', cats: ['sports', 'two-player'], players: '1-2', color: '#ff9f1c', hot: true,
    blurb: 'كرة سلة برؤوس ضخمة! سجّل على الكمبيوتر أو على صديقك.',
    controls: [{ keys: ['A', 'D', 'W'], action: 'حركة / قفز' }, { keys: ['S'], action: 'تصويب' }] },
  { slug: 'wacky-soccer', title: 'كرة القدم المجنونة', cats: ['sports', 'two-player'], players: '1-2', color: '#2ecc71',
    blurb: 'كرة قدم بزر واحد. فوضى ومرح وأهداف!',
    controls: [{ keys: ['W'], action: 'اللاعب 1: قفز وركل' }, { keys: ['↑'], action: 'اللاعب 2: قفز وركل' }] },
  { slug: 'pool-party', title: 'حفلة البلياردو', cats: ['sports'], players: '1-2', color: '#1abc9c',
  ...
  { slug: 'critter-mart', title: 'سوق الحيوانات', cats: ['idle'], players: '1', color: '#f4b400', hot: true,
    blurb: 'أدِر سوبرماركت خاصًا بك! ازرع ورتّب وبِع واربح.',
    controls: [{ keys: ['W', 'A', 'S', 'D'], action: 'مشي' }] },
  { slug: 'pizza-clicker', title: 'إمبراطورية البيتزا', cats: ['idle'], players: '1', color: '#ff6b35',
    blurb: 'انقر لتصنع البيتزا، وظّف الطهاة وابنِ إمبراطوريتك.',
    controls: [{ keys: ['انقر'], action: 'اصنع بيتزا' }] },
  { slug: 'block-world', title: 'عالم المكعبات', cats: ['idle', 'arcade'], players: '1', color: '#5fbf3f', hot: true,
