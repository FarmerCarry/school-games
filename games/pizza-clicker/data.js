...
(function (root) {
  ...
  /* ---------------------------------------------------------- buildings */
  // cost = base * 1.15^owned  (QA pass: upper buildings made cheaper so a
  // 15-20 minute recess session reaches 4-5 building types instead of 3)
  PZ.COST_SCALE = 1.15;
  PZ.BUILDINGS = [
    ...
    { name: 'سكوتر التوصيل', cost: 650, pps: 8, desc: 'يوصل البيتزا ساخنة قبل أن تبرد!' },
    { name: 'شاحنة الطعام', cost: 4500, pps: 48, desc: 'مطبخ على عجلات يبيع البيتزا في كل شارع.' },
    { name: 'مطعم البيتزا', cost: 30000, pps: 280, desc: 'طاولات مربّعة وجبنة ممطوطة في كل مكان!' },
    { name: 'مصنع البيتزا', cost: 200000, pps: 1650, desc: 'آلات عملاقة تصنع البيتزا ليلًا ونهارًا.' },
    { name: 'منطاد البيتزا', cost: 1.4e6, pps: 9800, desc: 'يُسقط البيتزا بالمظلات من السماء!' },
    { name: 'قاعدة القمر', cost: 1e7, pps: 60000, desc: 'البيتزا هنا تطفو... أمسكها قبل أن تطير!' },
    { name: 'بوابة البيتزا', cost: 7.5e7, pps: 380000, desc: 'تجلب البيتزا من عالم آخر كله جبنة!' },
    { name: 'مجرة البيتزا', cost: 5.5e8, pps: 2.4e6, desc: 'نجوم من الببروني وكواكب من الجبن!' }
  ];
