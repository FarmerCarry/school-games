 ...
 *   tip:    short hint shown when the level starts
 */
(function (root) {
  var L = [
    /* ---------------- Box 1: Cardboard Box ---------------- */
    { name: 'First Bite', tip: 'Swipe across the rope to cut it!',
      candy: [640, 280], munch: [640, 596],
      ropes: [{ x: 640, y: 96 }],
      stars: [[640, 360], [640, 415], [640, 468]] },

    { name: 'Swing Time', tip: 'Cut when the candy swings over Munch!',
      candy: [800, 190], munch: [262, 598],
      ropes: [{ x: 520, y: 100 }],
      stars: [[520, 390], [335, 322], [252, 440]] },

    { name: 'Double Knot', tip: 'Which rope should go first?',
    ...
    { name: 'On the Move', tip: 'Some pins slide around!',
    ...
    /* ---------------- Box 2: Gift Box ---------------- */
    { name: 'Puff Puff', tip: 'Click the air puffer to blow the bubble!',
    ...
    { name: 'Boing!', tip: 'Bouncy pads send candy flying!',
  ...
  var BOXES = [
    { name: 'Cardboard Box', theme: 'cardboard', from: 0, to: 15, need: 0 },
    { name: 'Gift Box', theme: 'gift', from: 15, to: 30, need: 24 }
  ];
  L.BOXES = BOXES;
  root.MUNCH_LEVELS = L;
